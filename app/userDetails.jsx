...
export default function UserDetailsScreen() {
  ...
  const menuItems = [
    { icon: 'person-outline', label: 'View / Edit Profile', route: '/ViewProfile', top: 240, backgroundColor:'black' },
    { icon: 'add-circle-outline', label: 'Manage Policy', route: '/AddPolicy', top: 310 },  // Updated route to AddPolicy
